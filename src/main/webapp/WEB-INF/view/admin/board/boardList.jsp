...
<tr>
	...
	<td class="text-center">${lst.fileCnt }</td>
	<td>${lst.userNm } </td>
...
<button type="button" class="btn btn-primary btn-sm" onClick="save()">등록</button>
...
function save(){
	document.location.href = "/board/${flag}/insert/form";
}


function view(srl){
	document.frm.action = "/board/${flag}/view"
	$("#boardSrl").val(srl);
	document.frm.submit();
}
